<div align="center">
  ...
  <h1>@episclera/renovate-config</h1>
  <p>A shareable renovate config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
**Under the hood this config just is extended from renovate [config:base](https://docs.renovatebot.com/presets-config/)**
