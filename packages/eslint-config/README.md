<div align="center">
  ...
  <h1>@episclera/eslint-config</h1>
  <p>A shareable eslint config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
Install: `npm i -D @episclera/eslint-config`

And in your `.eslintrc.js` file just put this content.

```js
module.exports = require('@episclera/eslint-config')
```
