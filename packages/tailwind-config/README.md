<div align="center">
  ...
  <h1>@episclera/tailwind-config</h1>
  <p>A shareable tailwindcss config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
Install: `npm i -D @episclera/tailwind-config`

And in your `tailwind.config.js` file just put this content.

```js
module.exports = require('@episclera/tailwind-config')
```
