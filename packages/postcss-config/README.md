<div align="center">
  ...
  <h1>@episclera/postcss-config</h1>
  <p>A shareable postcss config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
Install: `npm i -D @episclera/postcss-config`

And in your `postcss.config.js` file just put this content.

```js
module.exports = require('@episclera/postcss-config')
```
