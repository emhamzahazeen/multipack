<div align="center">
  ...
  <h1>@episclera/stylelint-config</h1>
  <p>A shareable stylelint config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
And in your `.stylelintrc.js` file just put this content.
