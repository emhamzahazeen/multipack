<div align="center">
  ...
  <h1>@episclera/jest-config</h1>
  <p>A shareable jest config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
Install: `npm i -D @episclera/jest-config`

And in your `jest.config.js` file just put this content.

```js
module.exports = require('@episclera/jest-config')
```
