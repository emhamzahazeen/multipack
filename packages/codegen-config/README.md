<div align="center">
  ...
  <h1>@episclera/codegen-config</h1>
  <p>A shareable codegen config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo.</p>
  <p>
...
Install: `npm i -D @episclera/codegen-config`

And in your `.codegenrc.js` file just put this content.

```js
module.exports = require('@episclera/codegen-config')
```
