<div align="center">
  ...
  <h1>@episclera/webpack-config</h1>
  <p>A shareable webpack config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
Install: `npm i -D @episclera/webpack-config`

And in your `webpack.config.js` file just put this content.

```js
const { commonWebpackConfig } = require('@episclera/webpack-config')
