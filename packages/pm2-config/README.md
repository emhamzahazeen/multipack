<div align="center">
  ...
  <h1>@episclera/pm2-config</h1>
  <p>A shareable pm2 config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo.</p>
  <p>
...
Install: `npm i -D @episclera/pm2-config`

And in your `pm2.config.js` file just put this content.

```js
module.exports = require('@episclera/pm2-config')
```
