<div align="center">
  ...
  <h1>@episclera/prettier-config</h1>
  <p>A shareable prettier config. Part of <a href="https://github.com/episclera/multipack">multipack</a> monorepo</p>
  <p>
...
Install: `npm i -D @episclera/prettier-config`

And in your `.prettierrc.js` file just put this content.

```js
module.exports = require('@episclera/prettier-config')
```
